...
#define FFMPEG_CONFIGURATION "--target-os=linux --cross-prefix=/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/toolchain-android/bin/arm-linux-androideabi- --arch=arm --cpu=cortex-a8 --disable-decoders --disable-encoders --disable-muxers --disable-filters --disable-doc --disable-ffplay --disable-ffprobe --disable-ffserver --disable-debug --disable-shared --disable-demuxers --enable-decoder=pcm_mulaw --enable-decoder=h264 --enable-decoder=aac --enable-decoder=mjpeg --enable-decoder=pcm_s8 --enable-decoder=pcm_u8 --enable-decoder=pcm_s16le --enable-decoder=pcm_s16be --enable-decoder=pcm_u16le --enable-decoder=pcm_u16be --enable-encoder=h264 --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=libx264 --enable-muxer=hls --enable-muxer=h264 --enable-muxer=rtsp --enable-muxer=mjpeg --enable-muxer=image2 --enable-muxer=aac --enable-demuxer=hls --enable-demuxer=h264 --enable-demuxer=mjpeg --enable-demuxer=image2 --enable-demuxer=pcm_mulaw --enable-demuxer=rtsp --enable-demuxer=concat --enable-demuxer=pcm_s8 --enable-demuxer=pcm_u8 --enable-demuxer=pcm_s16le --enable-demuxer=pcm_s16be --enable-demuxer=pcm_u16le --enable-demuxer=pcm_u16be --enable-demuxer=foscam --enable-demuxer=foscam_s16le --enable-demuxer=hevc --enable-demuxer=aac --enable-filter=scale --enable-filter=fps --enable-filter=aresample --enable-runtime-cpudetect --sysroot=/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/toolchain-android/sysroot --enable-pic --enable-pthreads --enable-version3 --enable-hardcoded-tables --enable-gpl --enable-yasm --enable-neon --enable-thumb --enable-libx264 --enable-nonfree --enable-static --pkg-config=/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/ffmpeg-pkg-config --prefix=/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/build/armeabi-v7a-neon --extra-cflags='-I/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/toolchain-android/include -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fno-strict-overflow -fstack-protector-all -mfpu=neon' --extra-ldflags='-L/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/toolchain-android/lib -Wl,-z,relro -Wl,-z,now -pie' --extra-cxxflags="
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/build/armeabi-v7a-neon/share/ffmpeg"
#define AVCONV_DATADIR "/Users/gavinlin/workspace/github/CammyRecorder/native-for-android/build/armeabi-v7a-neon/share/ffmpeg"
